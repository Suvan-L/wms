...
import org.suvan.upms.dao.mapper.*;
import org.suvan.upms.dao.model.*;
import org.suvan.upms.rpc.api.UpmsApiService;
import org.suvan.upms.rpc.mapper.UpmsApiMapper;
...
public class UpmsApiServiceImpl implements UpmsApiService {
     ...
     */
    @Override
    @Cacheable(value = "wms-upms-rpc-service-ehcache", key = "'selectUpmsPermissionByUpmsUserId_' + #upmsUserId")
     ...
     */
    @Override
    @Cacheable(value = "wms-upms-rpc-service-ehcache", key = "'selectUpmsRoleByUpmsUserId_' + #upmsUserId")

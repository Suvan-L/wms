...
$(function() {
	...
	$table.bootstrapTable({
		...
		columns: [
            ...
            {field: 'systemId', title: '所属系统编号', sortable: true, align: 'center'},
			{field: 'pid', title: '所属上级权限编号', sortable: true, align: 'center'},
			{field: 'name', title: '权限名称', sortable: true},
			{field: 'type', title: '类型', formatter: 'typeFormatter', sortable: true},

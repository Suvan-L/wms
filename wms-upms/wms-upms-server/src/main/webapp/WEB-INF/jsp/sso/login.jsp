...
<head>
    ...
    <link href="${basePath}/resources/wms-admin/plugins/waves-0.7.5/waves.min.css" rel="stylesheet"/>
    <link href="${basePath}/resources/wms-admin/plugins/checkbix/css/checkbix.min.css" rel="stylesheet"/>
    <link href="${basePath}/resources/wms-admin/css/login.css" rel="stylesheet"/>
</head>
<body>
<div id="login-window">
...
<script src="${basePath}/resources/wms-admin/plugins/checkbix/js/checkbix.min.js"></script>
<script>var BASE_PATH = '${basePath}';</script>
<script>var BACK_URL = '${param.backurl}';</script>
<script src="${basePath}/resources/wms-admin/js/login.js"></script>
<script>

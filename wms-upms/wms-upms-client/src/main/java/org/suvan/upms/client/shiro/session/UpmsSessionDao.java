package org.suvan.upms.client.shiro.session;

import org.suvan.common.util.RedisUtil;
import org.suvan.upms.client.util.SerializableUtil;
...
public class UpmsSessionDao extends CachingSessionDAO {
    ...
    // 会话key
    private final static String ZHENG_UPMS_SHIRO_SESSION_ID = "wms-upms-shiro-session-id";
    // 全局会话key
    private final static String ZHENG_UPMS_SERVER_SESSION_ID = "wms-upms-server-session-id";
    // 全局会话列表key
    private final static String ZHENG_UPMS_SERVER_SESSION_IDS = "wms-upms-server-session-ids";
    // code key
    private final static String ZHENG_UPMS_SERVER_CODE = "wms-upms-server-code";
    // 局部会话key
